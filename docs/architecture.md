...
- given the RetailChain's dataset size, **redundancy** caused by the use of the star scheme can be seen as negligible. The dimensions' denormalization benefits are in this case more important than the storage cost (besides, nowadays the value of the storage cost is often perceived as trivial).
